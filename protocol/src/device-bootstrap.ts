...
import {
  DEVICE_STATE_ACK_ERROR_CODES,
  DEVICE_STATE_ACK_TYPE,
  DEVICE_STATE_ACK_VERSION,
  DeviceStateAckError,
  parseDeviceStateAck,
} from './device-state-sync.js';
import type {
  DeviceStateAck,
  DeviceStateAckErrorCode,
  DeviceStateAppliedAck,
  DeviceStateErrorAck,
} from './device-state-sync.js';

export const DEVICE_BOOTSTRAP_ACK_VERSION = DEVICE_STATE_ACK_VERSION;
export const DEVICE_BOOTSTRAP_ACK_TYPE = DEVICE_STATE_ACK_TYPE;
...
export const DEVICE_BOOTSTRAP_ACK_ERROR_CODES = DEVICE_STATE_ACK_ERROR_CODES;
...
export type DeviceBootstrapAckErrorCode = DeviceStateAckErrorCode;
export type DeviceBootstrapAppliedAck = DeviceStateAppliedAck;
export type DeviceBootstrapErrorAck = DeviceStateErrorAck;
export type DeviceBootstrapAck = DeviceStateAck;
...
export { DeviceStateAckError as DeviceBootstrapAckError };
...
export const parseDeviceBootstrapAck = parseDeviceStateAck;
